...
public class MainActivity extends AppCompatActivity {
    ...
    public void cambiar_btn1(){
        if (estado_btn1 == 0){
            estado_btn1 = 1;
            btn1.setBackgroundColor(rgb(247,246,243));
        }
        else{
            estado_btn1 = 0;
    ...
    private void cambiar_btn2(){
        if(estado_btn2 == 0){
            estado_btn2 = 1;
            btn2.setBackgroundColor(rgb(247,246,243));
        }
        else {
            estado_btn2 = 0;
    ...
    private void cambiar_btn3(){
        if(estado_btn3 == 0){
            estado_btn3 = 1;
            btn3.setBackgroundColor(rgb(247,246,243));
        }
        else{
            estado_btn3 = 0;
    ...
    private void cambiar_btn4(){
        if(estado_btn4 == 0){
            estado_btn4 = 1;
            btn4.setBackgroundColor(rgb(247,246,243));
        }
        else{
            estado_btn4 = 0;
